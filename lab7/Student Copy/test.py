...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(usage=f"python {path.basename(__file__)} --ID CAMPUS_SECTION_SRN_Lab7.py")
    parser.add_argument("--ID", required=True, help="where ID is CAMPUS_SECTION_SRN_Lab7.py")
