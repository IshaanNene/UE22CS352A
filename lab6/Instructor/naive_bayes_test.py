...
if __name__ == "__main__":
    ...
    try:
        ...
        parser = argparse.ArgumentParser(usage=f"python {path.basename(__file__)} --id <File_Name.py>")
        parser.add_argument("--id", required=True, help="where ID is <File_Name.py>")
